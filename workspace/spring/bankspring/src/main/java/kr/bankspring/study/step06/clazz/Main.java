package kr.bankspring.study.step06.clazz;
...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ApplicationContext context = 
        new ClassPathXmlApplicationContext("kr/bankspring/study/step06/clazz/application-context.xml");
    //DAO 사용
...
//    BankFacade bankFacade = new BankFacade(bankDao);
    ...
    newUser.setUserid("boojongmin13");
